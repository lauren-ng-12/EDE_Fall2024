...
gage_within_15km <- gage_utm[unlist(st_within(gage_utm, buffer_15km, sparse=TRUE))]
...
LancasterGagesMap <- ggplot()+
  ...
  geom_sf(data = gage_in_lancaster, aes(size = 2), color = "red")+
  geom_sf(data = gage_within_15km, aes( size = 2), color= "green")
