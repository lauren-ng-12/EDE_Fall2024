...
```{r echo=FALSE, fig.align='left', fig.cap="Distribution of Ozone Levels 2018", fig.height=4, fig.width=6, message=FALSE, warning=FALSE}

#Wrangle data for ozone in 2018 by month. Reclassify month as factors with unique levels.
ozone_2018 <- epa_data %>%
  filter(Year==2018) %>%
  group_by(Month) 

ozone_2018$Month <- factor(ozone_2018$Month,levels=unique(ozone_2018$Month))
...
ozone_2019$Month <- factor(ozone_2019$Month,levels=unique(ozone_2019$Month))
...
## Git Repository
https://github.com/lauren-ng-12/EDE_Fall2024/tree/main
