...
setwd('./Data') #note:capitalization counts in the paths
getwd()
here()
...
#Ex1
str_today <- "2023-feb-7" #if I was using as date, I would have to make sure all the dates are in this same format with the dashes
...
#Alternative 1
date_obj_past <- fast_strptime(str_past,"%y-%b-%d",cutoff_2000=24L) #b is lowercase month first three letters. L means it is integer, not a decimal (long integer). 
date_obj_past
...
## What class is the dow column? Day of the week
class(sites$dow)
