...
#gives max value in that vector
max(vector1)
...
#multiply each value of vector 1 with vector 4
vector1 * vector4
...
#gives opposite of what is in vector 3
!vector3
...
temps_C <- (temps_F)- 32 * 5/9  #this alone won't generate answers, you need to call it in the next line
temps_C
```
...
matrix1[4, 1] #row 4, column 1 results in the value of 4
#anything before comma is row, after comma is column

matrix1[4,  ] #fourth row of matrix, all the elements

matrix1[ , 3] #third column of matrix, all the elements

matrix1[c(12, 14)] #gives you the element that is stored in the 12th and 14th position 

matrix1[c(12:14)] #gives you element stored in positions 12 through 14

matrix1[2:4, 1:3] #rows 2, 3, and 4 in columns 1, 2, and 3
...
#double square brackets give the value of the 4th object in the list
#if you want to change value in list, use double brackets
list1[[4]] = 44
```
...
# Data Frames ----need to have same number of rows
